...
#define DEFAULT_KP     20.0  // Пропорциональный коэффициент (снижен для плавности)
#define DEFAULT_KI     0.0   // Интегральный коэффициент
#define DEFAULT_KD     12.0  // Дифференциальный коэффициент (снижен)

// Агрессивный PID (при большой ошибке) - только для критических ситуаций
#define AGGRESSIVE_KP  40.0   // Kp для резких поворотов (снижен с 50)
#define AGGRESSIVE_KD  25.0   // Kd для резких поворотов (снижен с 30)
