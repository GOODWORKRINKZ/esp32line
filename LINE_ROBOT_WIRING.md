...
**Подключение:**
- Один контакт кнопки → GPIO 4
- Второй контакт кнопки → GND
- Внутренний подтягивающий резистор активирован программно (INPUT_PULLUP)
- При нажатии кнопки робот переключается между режимами старт/стоп
...
|------|----------------------|----------------------|---------|
| 4    | Кнопка старт/стоп    | Тактовая кнопка      | INPUT   |
...
### Шаг 4: Проверка кнопки старт/стоп
```cpp
...
// Ожидаем: при нажатии кнопки выводится "Кнопка нажата!"
```
